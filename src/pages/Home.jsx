...
function Home() {
  ...
  return (
    <div className="space-y-16">
          ...
          {featuredProperties.map((property, index) => (
            ...
            >
              <div className="relative h-48">
                ...
                />
                <div className="absolute top-4 right-4 badge-surface px-3 py-1 rounded-full text-accent font-semibold shadow-sm">
                  {property.status}
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <p className="text-sm text-meta">Price</p>
                    <p className="font-semibold">${property.price.usd.toLocaleString()}</p>
                    <p className="text-sm text-accent">{property.price.eth} ETH</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm text-meta">ROI</p>
      ...
      {/* Why Choose Us */}
      <section className="page-bg pt-16">
        <div className="container">
          <div className="text-center mb-12">
