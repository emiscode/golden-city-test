...
function Properties() {
  ...
  return (
    <div className="min-h-screen page-bg">
        ...
        <div className="container py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button
                className={`p-2 rounded-md ${showFilters ? 'bg-primary-100 text-primary-600' : 'hover-surface-muted'}`}
      ...
      {/* Filters */}
      {showFilters && (
        <div className="surface shadow-md border-t">
          <div className="container py-6">
            ...
            >
              <Link to={`/properties/${property.id}`}>
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 right-4 badge-surface px-3 py-1 rounded-full text-accent font-semibold">
                    {property.status}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  {/* Token Details */}
                  <div className="surface rounded-lg p-3 mb-4">
                    <div className="flex justify-between text-sm">
