      ...
      <div className="surface shadow">
        <div className="container py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <Link to="/properties" className="link-muted">Properties</Link>
            <span className="text-secondary-400">/</span>
            <span className="text-accent">{property.title}</span>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="card p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  <p className="text-sm text-meta">Investment Price</p>
                ...
                <div className="text-right">
                  <p className="text-sm text-meta">Annual ROI</p>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-success">{property.metrics.totalReturn}</span>
                </div>
              </div>
